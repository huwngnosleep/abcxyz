...
increase() {
    this.setState((prevState, prevProps) => {value: prevState.value + 1});
}

// khi pass callback vào trong setState thì nó sẽ là Synchronous
this.setState((state, props) => {value: state.value + 1}, () => console.log(this.state.value));